...
namespace SmartStore.Core.Domain.Messages
{
	public class MessageTemplateNames
	{
		...
		public const string MembershipActivation = "Customer.MembershipActivation";
		...
		public const string CustomerWithdrawal = "Customer.Withdrawal";
		public const string CustomerWithdrawalToAdmin = "Customer.WithdrawalToAdmin";
		public const string CustomerDeposit = "Customer.Deposit";
		public const string CustomerDepositToAdmin = "Customer.DepositToAdmin";
		public const string CustomerDirecBonus = "Customer.DirectSponsorBonusEarned";
		public const string CustomerUnilevelBonus = "Customer.UnilevelBonusEarned";
		public const string CustomerMatrixBonus = "Customer.MatrixBonusEarned";
		public const string CustomerNewPositionPurchased = "Customer.NewPositionPurchased";
		public const string CustomerWithdrawalCompleted = "Customer.WithdrawalCompleted";
		public const string CustomerReferral = "Customer.NewReferral";
