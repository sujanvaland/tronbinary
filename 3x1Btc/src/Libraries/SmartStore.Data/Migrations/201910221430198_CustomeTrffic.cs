namespace SmartStore.Data.Migrations
{
    ...
    public partial class CustomeTrffic : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CustomerTraffic", "CustomerId", "dbo.Customer");
            //DropIndex("dbo.AdCampaign", new[] { "CustomerId" });
            DropIndex("dbo.CustomerTraffic", new[] { "CustomerId" });
