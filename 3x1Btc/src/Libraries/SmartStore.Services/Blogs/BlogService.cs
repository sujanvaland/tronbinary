...
namespace SmartStore.Services.Blogs
{
    ...
    public partial class BlogService : IBlogService
    {
		...
		public virtual IPagedList<BlogPost> GetAllBlogPosts(int storeId, int languageId,int customerId,
			DateTime? dateFrom, DateTime? dateTo, int pageIndex, int pageSize, bool showHidden = false, DateTime? maxAge = null)
        {
			...
			if (customerId > 0)
				query = query.Where(b => customerId == b.CustomerId);
			...
			bool showHidden = false)
        {
			...
			var blogPostsAll = GetAllBlogPosts(storeId, languageId, 0,null, null, 0, int.MaxValue, showHidden);
		...
		public virtual IList<BlogPostTag> GetAllBlogPostTags(int storeId, int languageId, bool showHidden = false)
        {
			...
			var blogPosts = GetAllBlogPosts(storeId, languageId, 0,null, null, 0, int.MaxValue, showHidden);
