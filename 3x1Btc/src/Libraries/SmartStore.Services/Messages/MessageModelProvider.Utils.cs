...
namespace SmartStore.Services.Messages
{
	public partial class MessageModelProvider
	{
		...
		private string BuildActionUrl(string action, string controller, object routeValues, MessageContext ctx)
		{
			...
			{
				dynamic routeval = routeValues;
				var baseUri = "www.stallionbooster.com/#/passwordreset/?token=" + routeval.token + "&emai=" + routeval.email;
				//var baseUri = "www.globalcryptoteam.com/#/passwordreset/?token="+ routeval.token +"&emai="+routeval.email;
				return baseUri;
			}
