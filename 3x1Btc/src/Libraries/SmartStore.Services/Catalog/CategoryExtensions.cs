...
namespace SmartStore.Services.Catalog
{
    ...
    public static class CategoryExtensions
    {
        ...
        /// <param name="placedunderId">Parent category identifier</param>
        /// <param name="ignoreCategoriesWithoutExistingParent">A value indicating whether categories without parent category in provided category list (source) should be ignored</param>
        /// <returns>Sorted categories</returns>
        public static IList<T> SortCategoryNodesForTree<T>(this IEnumerable<T> source, int placedunderId = 0, bool ignoreCategoriesWithoutExistingParent = false)
			where T : ICategoryNode
        {
            ...
            var childNodes = source.Where(c => c.ParentCategoryId == placedunderId).ToArray();
