...
namespace SmartStore.Admin
{
    public static class MappingExtensions
    {
		...
		public static CustomerPlanModel ToModel(this CustomerPlan entity)
		{
			return Mapper.Map<CustomerPlan, CustomerPlanModel>(entity);
		}

		public static Transaction ToEntity(this TransactionModel model)
		{
			return Mapper.Map<TransactionModel, Transaction>(model);
		}
		public static TransactionModel ToModel(this Transaction entity)
		{
			return Mapper.Map<Transaction, TransactionModel>(entity);
		}
