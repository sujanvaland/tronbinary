...
namespace SmartStore.Admin.Infrastructure
{
	public class AutoMapperAdminProfile : Profile
	{
		...
		public AutoMapperAdminProfile()
		{
			...
			CreateMap<AdCampaign, AdCampaignModel>();
			CreateMap<AdCampaignModel, AdCampaign>();
			//category
...
#pragma warning restore 612, 618
			...
			CreateMap<CustomerPlanModel, CustomerPlan>();
			CreateMap<CustomerPlan, CustomerPlanModel>();
