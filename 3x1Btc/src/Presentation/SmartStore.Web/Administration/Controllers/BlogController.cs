    ...
    public class BlogController : AdminControllerBase
	{
		...
		public ActionResult List(GridCommand command)
        {
			...
			if (_permissionService.Authorize(StandardPermissionProvider.ManageBlog))
			{
				...
				var blogPosts = _blogService.GetAllBlogPosts(0, 0,CustomerId, null, null, command.Page - 1, command.PageSize, true);
        ...
        public ActionResult Create()
        {
			...
			var blogPosts = _blogService.GetAllBlogPosts(0, 0, _workContext.CurrentCustomer.Id, null, null, 0, int.MaxValue, true);
			if(blogPosts.Count >= 3)
			{
				NotifyError("You already have 3 Blog Post");
				return RedirectToAction("List");
			}
