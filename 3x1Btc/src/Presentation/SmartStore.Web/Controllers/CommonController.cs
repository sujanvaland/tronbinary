...
namespace SmartStore.Web.Controllers
{
	public partial class CommonController : PublicControllerBase
    {
		...
		public ActionResult Footer()
        {
			...
			model.SmartStoreHint = "<a href='https://www.alienprofit.space/' class='sm-hint' target='_blank'><strong>{0}</strong></a> by Alien Profit &copy; {1}"
		...
		#endregion
		[ChildActionOnly]
		public ActionResult Banner125()
		{
			var banner = _adCampaignService.GetRandomAds("Banner", "Impression", "125", 1);
			return PartialView(banner.FirstOrDefault());
		}
		[ChildActionOnly]
		public ActionResult Banner468()
		{
			var banner = _adCampaignService.GetRandomAds("Banner", "Impression", "468", 1);
			return PartialView(banner.FirstOrDefault());
		}
		[ChildActionOnly]
		public ActionResult Banner728()
		{
			var banner = _adCampaignService.GetRandomAds("Banner", "Impression", "728", 1);
			return PartialView(banner.FirstOrDefault());
		}

		public ActionResult ProgramListing()
		{
			var banner = _adCampaignService.GetRandomAds("Banner", "Impression", "468", 10);
			return View(banner);
		}
	}
}
