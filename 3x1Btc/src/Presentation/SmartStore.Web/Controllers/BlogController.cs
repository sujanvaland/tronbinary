...
namespace SmartStore.Web.Controllers
{
    ...
    public partial class BlogController : PublicControllerBase
    {
        ...
        public ActionResult ListRss(int? languageId)
        {
			...
			var blogPosts = _blogService.GetAllBlogPosts(_storeContext.CurrentStore.Id, languageId.Value, 0,null, null, 0, int.MaxValue, false, maxAge);
        ...
        public ActionResult BlogMonths()
        {
            ...
            var cachedModel = _cacheManager.Get(cacheKey, () =>
            {
				...
				var blogPosts = _blogService.GetAllBlogPosts(_storeContext.CurrentStore.Id,
					_workContext.WorkingLanguage.Id,0, null, null, 0, int.MaxValue);
