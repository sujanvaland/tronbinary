...
namespace SmartStore.Web.Models.Customer
{
    ...
    public partial class RegisterModel : ModelBase
    {
		...
		[SmartResourceDisplayName("Account.Fields.AccountNumber")]
		public string AccountNumber { get; set; }
		[SmartResourceDisplayName("Account.Fields.NICR")]
		public string NICR { get; set; }
		[SmartResourceDisplayName("Account.Fields.BankName")]
		public string BankName { get; set; }
		[SmartResourceDisplayName("Account.Fields.AccountHolderName")]
