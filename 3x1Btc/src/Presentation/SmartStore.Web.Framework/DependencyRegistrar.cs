...
namespace SmartStore.Web.Framework
{
	...
	public class CoreModule : Module
	{
		...
		protected override void Load(ContainerBuilder builder)
		{
			...
			builder.RegisterType<CustomerPlanService>().As<ICustomerPlanService>().InstancePerRequest();
			builder.RegisterType<BannerService>().As<IBannerService>().InstancePerRequest();
			builder.RegisterType<BoardService>().As<IBoardService>().InstancePerRequest();
			builder.RegisterType<AdCampaignService>().As<IAdCampaignService>().InstancePerRequest();
