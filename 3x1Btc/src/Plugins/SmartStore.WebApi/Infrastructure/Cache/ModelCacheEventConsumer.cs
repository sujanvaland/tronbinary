...
namespace SmartStore.WebApi.Infrastructure.Cache
{
    public class ModelCacheEventConsumer : IDbSaveHook
    {
        /// <summary>
		...
		public const string APIPRODUCT_SPECS_MODEL_KEY = "pres:apiproduct:specs-{0}-{1}";
		public const string APIPRODUCT_SPECS_PATTERN_KEY = "pres:apiproduct:specs*";
		...
		public const string CART_PICTURE_MODEL_KEY_API = "pres:cart:apipicture-{0}-{1}-{2}-{3}-{4}-{5}";
		public const string CART_PICTURE_PATTERN_KEY_API = "pres:cart:apipicture*";
